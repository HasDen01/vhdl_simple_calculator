...
HD_PWD='C:/design/simple_calculator/impl/calculator/calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calc_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source calc_top.tcl
